...
export function Navbarr(){
    ...
    <Navbar fluid rounded className={`z-10 pt-8 pb-8 transition duration-500 fixed left-0 right-0 top-0 bg-cyan-950 ${colorChange? '' : '-translate-y-3'}`}>
    <Navbar.Brand as={Link} href="https://flowbite-react.com">
      <Link className="text-white font-bold hover:text-white title" to="">START FRAMEWORK</Link>
    </Navbar.Brand>
    <Navbar.Toggle />
    <Navbar.Collapse>
    <Link to="about" className="p-2 m-0 text-white hover:text-white font-bold focus:bg-[#00bfa0] rounded-md duration-300 transition">About</Link>
